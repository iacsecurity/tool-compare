[comment]: <> (DO NOT EDIT THIS FILE, EDIT README.md.template INSTEAD)
...
|     | [Checkov](http://bridgecrew.io/) | [Cloudrail](http://indeni.com/cloudrail) | [KICS](https://www.kics.io/) | [Snyk](https://www.snyk.io/) | [Terrascan](https://www.accurics.com/) | [Tfsec](https://tfsec.dev/) |
|----|----|----|----|----|----|----|
|License|OSS|Freemium|OSS|Freemium|OSS|OSS|
|Custom Rules|Yes, Python|Yes, Python|Yes, Rego|No|Yes, Rego|Yes, JSON|


For more information on each tool, including demo credentials for those that have them, 
see [tools_details.yml](tools_details.yml).
...
|----|----|----|----|----|----|----|
|Tested Version|2.0.138[0m[0m[0m|1.2.170|||1.4.0||
|Total Catch Rate|67%|70%|79%|44%|16%|54%|


### test-cases/dynamic/terraform/aws/iam/iam-entities
| Test Case | Checkov | Cloudrail | KICS | Snyk | Terrascan | Tfsec |
|----|----|----|----|----|----|----|
### test-cases/dynamic/terraform/aws/iam/networking
| Test Case | Checkov | Cloudrail | KICS | Snyk | Terrascan | Tfsec |
|----|----|----|----|----|----|----|
### test-cases/static
| Test Case | Checkov | Cloudrail | KICS | Snyk | Terrascan | Tfsec |
...
|Category Catch Rate|50%|100%|50%|38%|0%|12%|
